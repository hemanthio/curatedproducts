  ...
  return (
    <a href={product.url} target="_blank">
      <main className={GeistSans.className}>
        <div className="border-[1.9px] max-sm:border-[1.5px] border-gray-300 relative font-medium bg-white flex flex-col gap-2  w-[300px] h-[250px] max-sm:w-full max-sm:h-auto rounded-2xl p-6">
          <img
            src={product.image}
            alt={product.name}
