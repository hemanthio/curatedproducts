        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-geist">
              DESCRIPTION 
              <span className="text-red-500">*</span>
              <span className="text-gray-500 text-xs">(min 8 words, max 12 words)</span>
            </label>
            <textarea
              name="description"
              required
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <label className="block text-sm font-geist">
                TAGS <span className="text-gray-500 text-xs">(Select 1-3(includes category))</span>
              </label>
              <div className="relative inline-block">
                <Info
                  className="h-4 w-4 text-gray-500 cursor-help"
